package com.example.order.application.query.service;
...
class OrderQueryServiceTest {
    ...
    void shouldFindOrderSummary() {
        ...
        // When & Then
        StepVerifier.create(service.handle(new com.example.order.application.in.query.OrderSummaryQuery(orderId)))
            .assertNext(result -> {
