...
public class OrderMapperImpl extends OrderMapper {
    ...
    public OrderEntity toEntity(Order order) {
        ...
        orderEntity.discountAmount( orderDiscountAmountAmount( order ) );
        ...
        orderEntity.items( orderItemMapper.toEntityList( order.getItems() ) );
    ...
    private BigDecimal orderDiscountAmountAmount(Order order) {
        ...
        BigDecimal amount = discountAmount.getAmount();
        if ( amount == null ) {
            return null;
        }
        return amount;
